...
//
       // withDuplicates.addEventToBack(new Jumping("Qualification", JumpTyp.HIGH_JUMP));
...
//
       // empty.addEventToFront(new Jumping("Start Event", JumpTyp.LONG_JUMP));
       // empty.clear();
//
       // empty.print();
//
...
//
       ...
       // valid.addEventToBack(new Jumping("Finals", JumpTyp.TRIPLE_JUMP));
//
       // valid.print();
//
       // try {
